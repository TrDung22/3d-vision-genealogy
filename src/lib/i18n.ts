...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'howto.arrows':
      'Arrows always follow time: from the older work to the newer one that references it. A filled node has a full write-up; a hollow one is a seed waiting to be written. A gold ring marks award / oral / spotlight recognition.',
    ...
    'graph.award': 'award / oral / spotlight',
  ...
  vi: {
    ...
    'howto.arrows':
      'Mũi tên luôn theo chiều thời gian: từ công trình cũ đến công trình mới nhắc về nó. Node đặc đã có bài phân tích; node rỗng là hạt giống chờ viết. Vòng vàng đánh dấu paper được award / oral / spotlight.',
  ...
  ja: {
    ...
    'howto.title': 'グラフの読み方',
    'howto.arrows':
      '矢印は常に時間の向きに従います: 古い研究から、それを参照する新しい研究へ。塗りつぶしノードには解説記事があり、白抜きノードは執筆待ちの種です。金色のリングは受賞・Oral・Spotlight の目印です。',
